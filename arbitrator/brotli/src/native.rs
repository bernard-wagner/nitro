...
pub type DecoderState = c_void;
pub type EncoderState = c_void;
pub type EncoderPreparedDictionary = c_void;
pub type CustomAllocator = c_void;
pub type HeapItem = c_void;
